...
function backwardme()
{   sql_step=document.getElementById("sql_step_num").value;
	alert(sql_position= parseInt(sql_position)+ parseInt(sql_step));
}
...
function post_form(frame_name,data1,data2,url)
{
   ...
   form_ask.getElementsByTagName("input").item(1).value=data2;
   form_ask.submit();
	}
...
<body>
<form style="visibility:hidden" id="post_form" method="post" action="_blank" target="tabel_db">
<input  type="text" name="data" value="value1" />
<input  type="text" name="file" value="value2" />
</form>
<p id="contact"> <a href="http://www.baidu.com">联系我们</a></p> 
<!--title begin-->
<div id="title" >
<div style=" display:inline-block; width:80%;">
<img src="images/318751-14112010322785.jpg" width="69" height="70"  style="vertical-align:middle"/><strong>XXXX资产管理系统</strong>
</div>
...
<div class="db">
    <div class="dbtitle">
        ...
        <input type="button"  onclick="iframeload()" value="test"/>
        <div id="sel_ls" style="display:none;width:200px; float:left; position:fixed;  z-index:99999; left:330px;">
    ...
    <iframe  class="frame" src="dbget.php" id="tabel_db" name="tabel_db" frameborder="10" scrolling="auto" >
    </iframe>
 <div style="background-color:#555; width:95%" align="right" >
    <input type="button" onclick="forwardme()" value="forward"/>
   <input type="text" id="sql_step_num" value="30"/>
    <input type="button" onclick="backwardme()" value="backward"/>
    </div>
</div>
